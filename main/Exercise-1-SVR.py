# -*- coding: utf-8 -*-
"""
Created on Thu May  3 01:10:12 2018

@author: Ghali Yakoub
"""
''' tunnig the parameters (the penalty error term C)'''
...
df['SVR FORECAST'] = y_pred_test 
df.to_csv(path_or_buf='ForecastTemplate1.csv', columns=['SVR FORECAST'], date_format='%Y%m%d %H:%M')
